...
## no classes !
all custom code has to be pure functionally Functional programming paradigm (no classes, only functions)
if there are external libraries that have classes , they can be used but we never write classes. 
